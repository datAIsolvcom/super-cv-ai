    ...
    >
      <header className={`border-b-2 pb-4 mb-4 flex flex-col items-center text-center ${template === "minimal" ? "items-start text-left border-none" : ""}`} style={{ borderColor: design.accentColor }}>
        ...
        <div className={`flex flex-wrap gap-x-4 gap-y-1 text-[0.9em] text-slate-600 ${template === "minimal" ? "justify-start" : "justify-center"}`}>
          {contact.email && <div className="inline-flex items-center gap-1"><span className="inline-flex items-center" style={{ verticalAlign: 'middle' }}><Mail size={14} className="shrink-0" style={{ verticalAlign: 'middle' }} /></span><Field tagName="span" value={contact.email} onSave={(v) => updateCvField("contact_info.email", v)} /></div>}
          {contact.phone && <div className="inline-flex items-center gap-1"><span className="inline-flex items-center" style={{ verticalAlign: 'middle' }}><Phone size={14} className="shrink-0" style={{ verticalAlign: 'middle' }} /></span><Field tagName="span" value={contact.phone} onSave={(v) => updateCvField("contact_info.phone", v)} /></div>}
          {contact.location && <div className="inline-flex items-center gap-1"><span className="inline-flex items-center" style={{ verticalAlign: 'middle' }}><MapPin size={14} className="shrink-0" style={{ verticalAlign: 'middle' }} /></span><Field tagName="span" value={contact.location} onSave={(v) => updateCvField("contact_info.location", v)} /></div>}
          {contact.linkedin && <div className="inline-flex items-center gap-1"><span className="inline-flex items-center" style={{ verticalAlign: 'middle' }}><Linkedin size={14} className="shrink-0" style={{ verticalAlign: 'middle' }} /></span><Field tagName="span" value={contact.linkedin} onSave={(v) => updateCvField("contact_info.linkedin", v)} /></div>}
          {contact.portfolio && <div className="inline-flex items-center gap-1"><span className="inline-flex items-center" style={{ verticalAlign: 'middle' }}><Globe size={14} className="shrink-0" style={{ verticalAlign: 'middle' }} /></span><Field tagName="span" value={contact.portfolio} onSave={(v) => updateCvField("contact_info.portfolio", v)} /></div>}
        </div>
      </header>
