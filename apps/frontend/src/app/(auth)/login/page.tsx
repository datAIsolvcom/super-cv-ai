...
import { Loader2, ArrowLeft, Sparkles, Eye, EyeOff } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-1/3 left-1/4 w-[500px] h-[500px] bg-[hsla(var(--accent-primary)/0.06)] rounded-full blur-[150px]" />
        <div className="absolute bottom-1/3 right-1/4 w-[400px] h-[400px] bg-purple-500/[0.04] rounded-full blur-[120px]" />
      </div>
        ...
        <LazyTiltCard tiltStrength={15} glareEnabled={true}>
          <div className="glass-panel p-8 rounded-3xl">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-[hsl(var(--text-secondary))] text-sm">Sign in to continue your journey</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full bg-[hsl(var(--surface-elevated))] border border-black/[0.06] dark:border-white/[0.08] rounded-xl p-4 pr-12 text-[hsl(var(--text-primary))] placeholder:text-[hsl(var(--text-muted))] focus:border-[hsla(var(--accent-primary)/0.5)] focus:shadow-[0_0_20px_hsla(var(--accent-primary)/0.15)] outline-none transition-all duration-300"
                  value={password}
  ...
  return (
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center">
        <div className="w-12 h-12 bg-gradient-to-br from-amber-400 to-amber-600 rounded-2xl flex items-center justify-center animate-pulse">
